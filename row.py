...
def export_circles_from_image(circles, out_dir, file_path, im, hgt, wdth, ins):
    ...
    for i in circles[0, :]:
        ...
        centerX = i[0]
        centerY = i[1]
        radius = i[2] - ins  #: inset the radius by number of pixels to remove the circle and noise
